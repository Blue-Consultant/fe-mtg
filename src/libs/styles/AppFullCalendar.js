...
const AppFullCalendar = styled('div')(({ theme }) => ({
  ...
  '& .fc': {
    ...
    '& .fc-daygrid-day': {
      padding: '1px', // Se actualiza para ocupar mas espacio de 8px a 2px
      '& .fc-daygrid-day-top': {
        flexDirection: 'row'
      }
    },
    ...
    '& .fc-popover': {
      ...
      boxShadow: 'rgba(0, 0, 0, 0.15) 0px 2px 6px !important',
      ...
      '& .fc-popover-header': {
        ...
        borderStartStartRadius: 'var(--mui-shape-borderRadius) !important',
        borderStartEndRadius: 'var(--mui-shape-borderRadius) !important',
