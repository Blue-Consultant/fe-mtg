...
const Customizer = ({ breakpoint = 'lg', dir = 'ltr', disableDirection = false }) => {
  ...
  const handleSubmit = async e => {
    ...
    userSettings.additional_custom_settings = {}
      ...
      >
        <form onSubmit={handleSubmit}>
          <div className={styles.customizerBody}>
            ...
            <div className='flex flex-col gap-6'>
              {/* Layout fijo: solo horizontal (módulos/submódulos arriba) */}
              <div className='flex flex-col gap-2.5'>
          ...
          <Grid item xs={12} className='flex gap-4 pt-7 pb-7 flex-wrap justify-center'>
