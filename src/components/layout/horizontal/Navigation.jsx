...
const Navigation = ({ dictionary, inline = false }) => {
  // Hooks
  ...
  // If inline, render just the menu without extra containers
  if (inline && !isBreakpointReached) {
    return <HorizontalMenu dictionary={dictionary} />
  }
