    ...
    >
      ...
      <DialogContent>
        <Typography variant="body1" sx={{ textAlign: 'justify', lineHeight: 1.8, mb: 2 }}>
          Tienes un examen de ubicación asignado que debes completar antes de continuar.
          El examen tiene un límite de <strong>{pendingExam?.time_limit_minutes || 15} minutos</strong>.
        </Typography>
        ...
        {pendingExam?.scheduled_exam_at && (
          <Box sx={{ mb: 2 }}>
            ...
            <Typography variant="body1">
              {formatDate(pendingExam.scheduled_exam_at)}
            </Typography>
          </Box>
        )}
        ...
        <Box sx={{ display: 'flex', justifyContent: 'center', gap: 1, mt: 2, flexWrap: 'wrap' }}>
          <Chip 
            label={`${pendingExam?.time_limit_minutes || 15} minutos`}
            color="warning"
            variant="outlined"
          />
          <Chip 
