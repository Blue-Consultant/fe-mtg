...
import {
  ...
  setSubModules
} from '../slices/sub-modules'

//TODO: Devuelve todos los registros con paginación
export const fetchSubModulesPaginationThunks =
  ({ status = true, params = {} }) =>
  async dispatch => {
    try {
...
export const fetchSubModulesByModuleThunks =
  ({ module_id, status = true }) =>
  async dispatch => {
    try {
      dispatch(setLoading(true))
...
export const updateSubModuleThunk =
