 ...
 * Obtener todos los permisos de un rol
 */
export const fetchRolePermissionsPaginationThunk = ({status = true, params = {} }) => async dispatch => {
  try {
    dispatch(setLoading(true))
 ...
 */
export const updateRolePermissionsThunk = ({ role_id, assignments }) => async dispatch => {
  try {
    dispatch(setLoading(true))
