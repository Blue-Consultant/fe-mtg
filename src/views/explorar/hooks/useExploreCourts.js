 ...
 */
export function useExploreCourts({ lang, initialFecha, initialHoraInicio, initialHoraFin, initialCourtTypeId }) {
  ...
  const courts = useMemo(() => filters.applyClientFilters(courtsRaw), [courtsRaw, filters.applyClientFilters])
