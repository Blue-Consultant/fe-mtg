  ...
  return (
    <Link href={href} className={styles.card}>
      <div className={styles.cardImageWrap}>
        <OptimizedS3Image src={img} alt={name} fill className='object-cover' sizes='(max-width: 600px) 100vw, 320px' />
        ...
        {schedules.length > 0 && (
          <div className='flex flex-wrap gap-1 mt-2'>
            {schedules.slice(0, 3).map((s, idx) => (
              <span key={idx} className='text-xs text-gray-500 border border-gray-200 rounded px-1.5 py-0.5'>
