    ...
    >
      <DialogTitle variant='h4' className='flex flex-col gap-2 text-center sm:pbs-16 sm:pbe-6 sm:pli-16'>
        ...
        <Typography component='span' className='flex flex-col text-center text-sm'>
          {dictionary.modules?.rolesModulesSubmodules?.assignPermissionsSubtitle || 'Configure los permisos para el rol seleccionado'}
        </Typography>
      </DialogTitle>
      <form onSubmit={e => { e.preventDefault(); handleSubmit(); }}>
          ...
          <Grid container spacing={4} sx={{ mb: 4 }}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <FormControl fullWidth size="small">
                <InputLabel id="modal-role-select-label">
                  {dictionary.common?.role || 'Rol'}
                </InputLabel>
                <Select
                ...
                >
                  ...
                  {loadingRoles ? (
                    ...
                    localRolesList && localRolesList.map((role) => (
            ...
            <Grid item xs={12} sm={6} md={4}>
              <FormControl fullWidth size="small">
                <InputLabel id="modal-module-select-label">
                  {dictionary.common?.module || 'Módulo'}
                </InputLabel>
                <Select
                ...
                >
                  {loadingModules ? (
                    ...
                    localModulesList && localModulesList.map((module) => (
        ...
        <DialogActions className='justify-center pbs-0 sm:pbe-16 sm:pli-16 gap-2'>
          ...
          >
            {
              loadingRegister ? <CircularProgress sx={{ color: '#ffffff' }} size={24}/> : dictionary.common?.create || 'Crear'
            }
          </Button>
          <Button
            variant='outlined'
