    ...
    >
      <Grid item xs={12}>
        ...
        {existingSubModules.length > 0 && (
          ...
          >
            <InfoOutlinedIcon sx={{ color: theme => theme.palette.primary.main, fontSize: '1.1rem' }} />
            <Typography
              variant='body2'
              sx={{
            ...
            >
              Los submódulos deshabilitados ya se encuentran relacionados a este rol y no se pueden volver a ser
              seleccionados.
            </Typography>
          </Box>
        )}
        ...
        {loadingSubModules ? (
          ...
          <Box className='space-y-4'>
            {localModule.map(moduleId => {
              const mod = localModulesList.find(m => m.id === moduleId)
                            ...
                            >
                              <Box
                                ...
                                sx={{
                                  ...
                                  border: '1.5px solid',
                                  borderColor:
                                    isExisting || selectedSubModules.includes(subModule.id)
                                      ? 'primary.main'
                                      : '#E0E0E0',
                                  borderRadius: '8px',
                                  backgroundColor:
