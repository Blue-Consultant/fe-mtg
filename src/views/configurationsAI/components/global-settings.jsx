                ...
                {aiModels.map(model => (
                  <MenuItem key={model.value} value={model.value}>
                    <Box className='flex items-center'>
                      <Box className='w-3 h-3 rounded-full mr-3' style={{ backgroundColor: model.color }} />
                      {model.label}
                    </Box>
                  </MenuItem>
                ))}
                ...
                >
                  <Box className='space-y-3'>
                    ...
                    <TextField
                      ...
                      size='small'
                    />
                    <FormControlLabel control={<Switch defaultChecked />} label='Modo de depuración' />
                    <FormControlLabel control={<Switch defaultChecked />} label='Logs detallados' />
                  </Box>
                </motion.div>
              )}
            </CardContent>
