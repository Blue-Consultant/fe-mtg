...
import { Box, Card, Typography, Tabs, Tab, Avatar, Fab, Snackbar, Alert } from '@mui/material'
import {
    ...
    <Box className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4'>
      ...
      >
        ...
        <Box className='mb-8 text-center'>
          <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} transition={{ duration: 0.2, ease: 'easeOut' }}>
            <img
        ...
        <Card className='shadow-2xl border-0 overflow-hidden'>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
            ...
            >
              <Tab icon={<PsychologyIcon />} label='Prompts & Instrucciones' iconPosition='start' />
              <Tab icon={<DescriptionIcon />} label='Gestión de PDFs' iconPosition='start' />
          ...
          <TabPanel value={activeTab} index={0}>
            <PromptsInstructions prompts={prompts} onPromptChange={handlePromptChange} />
          </TabPanel>
        ...
        >
          <Alert onClose={() => setShowSnackbar(false)} severity={snackbarType} variant='filled' sx={{ width: '100%' }}>
            {snackbarMessage}
          </Alert>
        </Snackbar>
      </motion.div>
