...
const AddModulesDrawer = ({ open, handleClose, userDataReducer, dictionary, customerUserData, fetchModulesData }) => {
  const { control, errors, handleSubmit, isLoading, reset } = useModulesForm(
    customerUserData,
    handleClose,
    fetchModulesData
  )
          ...
          <Controller
            ...
            render={({ field }) => (
              <TextField
                ...
                maxRows={6}
                label={
                  dictionary.modules.modules?.components?.drawerModules?.formAddModules?.description || 'Descripción'
                }
