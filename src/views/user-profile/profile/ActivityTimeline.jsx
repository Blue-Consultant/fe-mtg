          ...
          <TimelineItem>
            ...
            <TimelineContent>
              ...
              <div className='flex items-center gap-2.5'>
                <CustomAvatar src={getAvatarSrcValidator('/images/avatars/1.png')} size={32} />
                <div>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              ...
              <AvatarGroup total={6} className='pull-up'>
                <Avatar alt='Remy Sharp' src={getAvatarSrcValidator('/images/avatars/1.png')} />
                <Avatar alt='Travis Howard' src={getAvatarSrcValidator('/images/avatars/8.png')} />
                <Avatar alt='Cindy Baker' src={getAvatarSrcValidator('/images/avatars/6.png')} />
              </AvatarGroup>
            </TimelineContent>
          </TimelineItem>
        </Timeline>
