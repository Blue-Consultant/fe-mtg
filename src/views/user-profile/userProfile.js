    ...
    users: {
      profile: {
        about: [
          ...
          {
            property: 'Idioma',
            value: data.language?.length > 0 ? data.language.join(', ') : 'N/A',
            icon: 'ri-translate-2'
          }
        ],
        contacts: [
          {
            property: 'Contacto',
            value: data.phone_number ? data.phone_number : '(123) 456-7890',
            icon: 'ri-phone-line'
          },
      ...
      projects: [
        ...
        },
        {
          ...
          avatar: '/images/logos/vue-bg.png',
          description: 'Figma home app design combines the user UI & UX.',
          avatarGroup: [
